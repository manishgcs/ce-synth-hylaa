...
if __name__ == '__main__':
    ...
    init_r = HyperRectangle([(0.5, 1.0), (0.9, 1.9), (0.9, 1.9), (0.0, 0.0)])  # For first usafe constraint

    # init_r = HyperRectangle([(0.8, 1.0), (0.8, 2.0), (0.8, 2.0), (0.0, 0.0)])  # for second usafe constraint

    usafe_arg = None
    if usafe_arg is None:
        usafe_constraint_list = [LinearConstraint([0.0, 1.0, 0.0, 0.0], -6.0)]  # R = 0.02
        # usafe_constraint_list = [LinearConstraint([1.0, 0.0, 0.0, 0.0], -9)]  # R= 0.1
        # usafe_constraint_list = [LinearConstraint([0.0, 0.0, -1.0, 0.0], -2.5)]  # R = 0.1
    ...
    #
    # Q2 = np.array([[3.33, 0, 0],
    #                [0, 0.39, 0],
    #                [0, 0, 0.52]], dtype=float)
    #
