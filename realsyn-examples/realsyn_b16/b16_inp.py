...
if __name__ == '__main__':
    ...
    a_matrix = np.array([[1.9027, -1, 0], [1, 0, 0], [0, 0, 1]], dtype=float)
    b_matrix = np.array([[1], [0], [0]], dtype=float)

    dim = len(b_matrix)
    l_idx = 0
    k_matrix = []
    controller_f_name = '/home/manishg/Research/realsyn/controller_outputs/' + str(16) + '_controller.txt'
