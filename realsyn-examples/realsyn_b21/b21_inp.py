...
if __name__ == '__main__':
    ...
    a_matrix = np.array([[2.6629, -1.1644, 0.66598, 0], [2, 0, 0, 0], [0, 0.5, 1, 0], [0, 0, 0, 1]], dtype=float)
    b_matrix = np.array([[0.25], [0], [0], [0]], dtype=float)

    dim = len(b_matrix)
    l_idx = 0
    k_matrix = []
    controller_f_name = '/home/manishg/Research/realsyn/controller_outputs/' + str(21) + '_controller.txt'
