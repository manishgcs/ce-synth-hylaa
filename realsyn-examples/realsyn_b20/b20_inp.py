...
if __name__ == '__main__':
    ...
    a_matrix = np.array([[2.2553, -1, 0], [1, 0, 0], [0, 0, 1]], dtype=float)
    b_matrix = np.array([[0.5], [0], [0]], dtype=float)
    dim = len(b_matrix)
    l_idx = 0
    k_matrix = []
    controller_f_name = '/home/manishg/Research/realsyn/controller_outputs/' + str(20) + '_controller.txt'
