...
def define_ha(settings, args):
    ...
    if usafe_r is None:
        usafe_set_constraint_list.append(LinearConstraint([-1.0, 0.0, 0.0], -1.25))
    else:
...
if __name__ == '__main__':
    ...
    init_r = HyperRectangle([(-2.0, -1.0), (-2.0, -1.0), (0, 0)])
    usafe_r = None
