...
def define_ha(settings, args):
    ...
    if usafe_r is None:
        usafe_set_constraint_list.append(LinearConstraint([0.0, -1.0, 0.0], -0.5))
        usafe_set_constraint_list.append(LinearConstraint([0.0, 1.0, 0.0], 0.75))
        usafe_set_constraint_list.append(LinearConstraint([-1.0, 0.0, 0.0], 0.25))
        usafe_set_constraint_list.append(LinearConstraint([1.0, 0.0, 0.0], 0.0))
    else:
...
if __name__ == '__main__':
    ...
    init_r = HyperRectangle([(0.5, 0.5), (1.46307116, 1.46307116), (0, 0)])
    usafe_r = None
    ...
    # rce_object = pv_object.compute_robust_ce()

    t_jumps = lce_object.switching_times
    k_matrices = [k_matrix1]
    # Q2 = 5*np.array([[0.11021594094727616, 0],
    #                  [0, 1/0.19165317133289705]], dtype=float)
...
# Q - 10
# [[26.41965284 19.89965106  0.        ]]
# [[-26.41965284 -17.89965106   0.        ]
#  [-25.41965284 -19.89965106   0.        ]
#  [  0.           0.           0.        ]]

# Q - 80
# [[73.9318205  54.14635875  0.        ]]
# [[-73.9318205  -52.14635875   0.        ]
#  [-72.9318205  -54.14635875   0.        ]
#  [  0.           0.           0.        ]]

# Q - 100
# [[82.60793967 60.39986251  0.        ]]
# [[-82.60793967 -58.39986251   0.        ]
#  [-81.60793967 -60.39986251   0.        ]
#  [  0.           0.           0.        ]]

# Q - 1 (with weights)
# [[ -1.69450413 -20.48277939   0.        ]
#  [ -0.69450413 -22.48277939   0.        ]
#  [  0.           0.           0.        ]]

# Q - 5 (with weights)
# [[ 2.55585613 50.11714482  0.        ]]
# [[ -2.55585613 -48.11714482   0.        ]
#  [ -1.55585613 -50.11714482   0.        ]
#  [  0.           0.           0.        ]]
